                        ...
                        <div className="lg:col-span-8 space-y-4">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                                <div className="space-y-1">
                                    <h1 className="text-3xl lg:text-4xl font-black text-slate-900 tracking-tight uppercase">Live Market</h1>
                                    <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 w-fit">
                                        ...
                                        <p className="text-blue-700 text-[10px] font-black uppercase tracking-widest">
                                            {liveCount > 0 ? `${liveCount} Active Opportunities` : 'Discovery Mode'}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="relative flex-1 group">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-3 rounded-2xl bg-white border border-slate-200 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 transition-all shadow-sm text-sm"
